...
import { requestApproval, alreadyCalled } from './lib/call.js?v=20260918-confirmation3';
import * as ledger from './lib/ledger.js?v=20260918-confirmation3';
...
async function callOwner() {
  ...
  try {
    ...
    const eligibility = decision.decision === 'approved' ? 'APPROVED · NOT DEPLOYED' : decision.decision === 'conditional' ? 'CONDITIONALLY APPROVED · OPEN CONDITION' : decision.decision === 'rejected' ? 'REJECTED' : 'HELD';
